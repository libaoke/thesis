...
set logscale x
#unset xtics
plot 'ycsba.dat' u 1:5:xtic(1) t "Gemini IOPS" w linespoints ls 1 axis x1y1,"" u 1:6 t "Gemini 读延迟" w linespoints ls 5 axis x1y2,"" u 1:7 t "Gemini 更新延迟" w linespoints ls 6 axis x1y2, "" u 1:2 t "EBS IOPS" w linespoints ls 3 axis x1y1, "" u 1:3 t "EBS 读延迟" w linespoints ls 2 axis x1y2, "" u 1:4 t "EBS 更新延迟" w linespoints ls 4 axis x1y2
quit
